              ...
              {chats.map(chat => (
                <div key={chat.userId}
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-800" style={{ color: chat.unreadCount > 0 ? "#111827" : "#374151" }}>
                        {chat.userName}
                      </h3>
                      <p className="text-sm text-gray-500 truncate max-w-xs" style={{ fontWeight: chat.unreadCount > 0 ? "600" : "400" }}>
